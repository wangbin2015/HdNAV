var deps = {
	...
	UtfGridLayer: {
		src: ['layer/tile/UtfGridLayer.js'],
		desc: 'Used to process utfGrid Json.',
		heading: 'Layers'
	},
	...
	LoacalSearch: {
		src: ['service/localsearch/LocalSearch.js',
				'service/localsearch/LocalSearchOptions.js',
				'service/localsearch/LocalResult.js'],
		desc: 'Used for citySearch,boundSearch,nearbySearch'
	},

	District: {
		src: ['service/district/DistrictSearch.js',
			'service/district/DistrictSearchOptions.js',
			'service/district/DistrictResult.js'],
		desc: 'Used for district search'
	},

	Geocoder: {
		src: ['service/geocoder/GeocoderSearch.js',
			'service/geocoder/GeocoderSearchOptions.js',
			'service/geocoder/GeocoderResult.js'],
		desc: 'Used for geocoder search'
	}
};
