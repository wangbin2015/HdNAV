describe('Polygon', function () {
	...
	describe("#initialize", function () {
		it("should never be flat", function () {
			...
			var polygon = new HDMap.Polygon(latLngs);

			expect(HDMap.Polyline._flat(polygon._latlngs)).to.be(false);
		...
		it("doesn't overwrite the given latlng array", function () {
			...
			var polygon = new HDMap.Polygon(sourceLatLngs);
		...
		it("can be initialized with holes", function () {
			...
			var polygon = new HDMap.Polygon(originalLatLngs);

			expect(polygon._latlngs).to.eql([
				[HDMap.latLng([0, 10]), HDMap.latLng([10, 10]), HDMap.latLng([10, 0])],
				[HDMap.latLng([2, 3]), HDMap.latLng([2, 4]), HDMap.latLng([3, 4])]
			]);
			expect(polygon.getLatLngs()).to.eql(polygon._latlngs);
		});
		...
		it("can be initialized with multi including hole", function () {
			...
			expect(polygon._latlngs).to.eql([
				[[HDMap.latLng([10, 20]), HDMap.latLng([30, 40]), HDMap.latLng([50, 60])]],
				[[HDMap.latLng([0, 10]), HDMap.latLng([10, 10]), HDMap.latLng([10, 0])], [HDMap.latLng([2, 3]), HDMap.latLng([2, 4]), HDMap.latLng([3, 4])]]
			]);
			expect(polygon.getLatLngs()).to.eql(polygon._latlngs);
		});

		it("can be added to the map when empty", function () {
			var polygon = new HDMap.Polygon([]).addTo(map);
	...
	describe('#getCenter', function () {
		...
		it('should compute center of a big simple polygon around equator', function () {
			...
			var layer = new HDMap.Polygon(latlngs).addTo(map);
			expect(layer.getCenter()).to.be.nearLatLng(HDMap.latLng([5, 5]), 1e-1);
		});
		...
		it('should compute center of a small simple polygon', function () {
			...
			expect(layer.getCenter()).to.be.nearLatLng(HDMap.latLng([0, 0]));
		});
	...
	describe("#_defaultShape", function () {
		...
		it("should return first latlngs on a polygon with hole", function () {
			var latlngs = [
				[HDMap.latLng([0, 12]), HDMap.latLng([13, 14]), HDMap.latLng([15, 16])],
				[HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6])]
			];
		...
		it("should return first latlngs on a multipolygon", function () {
			var latlngs = [
				[[HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6])]],
				[[HDMap.latLng([11, 12]), HDMap.latLng([13, 14]), HDMap.latLng([15, 16])]]
			];
	...
	describe("#addLatLng", function () {
		it("should add latlng to latlngs", function () {
			...
			expect(polygon._latlngs).to.eql([[HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6])]]);
		});
		...
		it("should add latlng to first latlngs on a polygon with hole", function () {
			...
			expect(polygon._latlngs[0]).to.eql([HDMap.latLng([0, 12]), HDMap.latLng([13, 14]), HDMap.latLng([15, 16]), HDMap.latLng([17, 0])]);
			expect(polygon._latlngs[1]).to.eql([HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6])]);
		});
		...
		it("should add latlng by reference on a polygon with hole", function () {
			...
			expect(polygon._latlngs[0]).to.eql([HDMap.latLng([0, 12]), HDMap.latLng([13, 14]), HDMap.latLng([15, 16])]);
			expect(polygon._latlngs[1]).to.eql([HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6]), HDMap.latLng([7, 8])]);
		});
		...
		it("should add latlng to first latlngs on a multi", function () {
			...
			expect(polygon._latlngs[0]).to.eql([[HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6])]]);
			expect(polygon._latlngs[1]).to.eql([[HDMap.latLng([11, 12]), HDMap.latLng([13, 14]), HDMap.latLng([15, 16])]]);
		});
		...
		it("should add latlng to latlngs by reference on a multi", function () {
			...
			expect(polygon._latlngs[1]).to.eql([[HDMap.latLng([1, 2]), HDMap.latLng([3, 4]), HDMap.latLng([5, 6])]]);
			expect(polygon._latlngs[0]).to.eql([[HDMap.latLng([11, 12]), HDMap.latLng([13, 14]), HDMap.latLng([15, 16])]]);
		});
		...
		it("should add latlng on first latlngs by default on a multipolygon with hole", function () {
			...
			expect(polygon._latlngs[0][0]).to.eql([HDMap.latLng([0, 10]), HDMap.latLng([10, 10]), HDMap.latLng([10, 0]), HDMap.latLng([-10, -10])]);
			expect(polygon._latlngs[0][1]).to.eql([HDMap.latLng([2, 3]), HDMap.latLng([2, 4]), HDMap.latLng([3, 4])]);
			expect(polygon._latlngs[1][0]).to.eql([HDMap.latLng([10, 20]), HDMap.latLng([30, 40]), HDMap.latLng([50, 60])]);
		});
		...
		it("should add latlng by reference on a multipolygon with hole", function () {
			...
			expect(polygon._latlngs[0][0]).to.eql([HDMap.latLng([10, 20]), HDMap.latLng([30, 40]), HDMap.latLng([50, 60])]);
			expect(polygon._latlngs[1][0]).to.eql([HDMap.latLng([0, 10]), HDMap.latLng([10, 10]), HDMap.latLng([10, 0])]);
			expect(polygon._latlngs[1][1]).to.eql([HDMap.latLng([2, 3]), HDMap.latLng([2, 4]), HDMap.latLng([3, 4]), HDMap.latLng([2, 2])]);
		});
