describe('PolylineGeometry', function () {
	...
	describe("#distanceTo", function () {
		it("calculates distances to points", function () {
			var p1 = map.latLngToLayerPoint(new HDMap.LatLng(55.8, 37.6));
			var p2 = map.latLngToLayerPoint(new HDMap.LatLng(57.123076977278, 44.861962891635));
			...
			.map(function (ll) {
				return new HDMap.LatLng(ll[0], ll[1]);
			});
