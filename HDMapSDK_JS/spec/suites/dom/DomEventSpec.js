describe('DomEvent', function () {
	...
	describe('#addListener', function () {
		it('adds a listener and calls it on event', function () {
			...
			HDMap.DomEvent.addListener(el, 'click', listener1);
			HDMap.DomEvent.addListener(el, 'click', listener2);
		...
		it('binds "this" to the given context', function () {
			...
			HDMap.DomEvent.addListener(el, 'click', function () {
				result = this;
			}, obj);
		...
		it('passes an event object to the listener', function () {
			...
			HDMap.DomEvent.addListener(el, 'click', function (e) {
				type = e && e.type;
			});
			simulateClick(el);
	...
	describe('#removeListener', function () {
		it('removes a previously added listener', function () {
			...
			HDMap.DomEvent.addListener(el, 'click', listener);
			HDMap.DomEvent.removeListener(el, 'click', listener);
	...
	describe('#stopPropagation', function () {
		it('stops propagation of the given event', function () {
			...
			HDMap.DomEvent.addListener(child, 'click', HDMap.DomEvent.stopPropagation);
			HDMap.DomEvent.addListener(el, 'click', listener);
	...
	describe('#preventDefault', function () {
		it('prevents the default action of event', function () {
			HDMap.DomEvent.addListener(el, 'click', HDMap.DomEvent.preventDefault);
