/*
Hdmap building, testing and linting scripts.
...
To check the code for errors and build Hdmap from source, run "jake".
...
var build = require('./build/build.js'),
    version = require('./src/Hdmap.js').version;
